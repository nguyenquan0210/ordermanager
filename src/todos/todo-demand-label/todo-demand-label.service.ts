...
import { TODO_DEMAND_LABEL } from 'src/commons/constants/schemaConst';
...
@Injectable()
export class TodoDemandLabelService {

    constructor(
        @InjectModel(TODO_DEMAND_LABEL) private model: Model<LabelDocument>
    ) {
    }
