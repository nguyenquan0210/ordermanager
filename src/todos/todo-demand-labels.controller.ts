...
@ApiTags('Todo demand labels')
@Controller('demands-labels')
@BearerJwt()
export class TodoDemandLabelController {
  constructor(private readonly labelsService: TodoDemandLabelService) { }
